 ...
 * ps：管理各种类型的handler，在启动时且所有handler已经创建完成后进行初始化，即注册到这个类中
 */
public final class TypeHandlerRegistry {
  ...
  // ps: 为什么这里是双层设计呢 ，比如：Java 类型中的 String 可能转换成数据库中的 varchar、char、text 等多种类型，所以可能对应多个handler
